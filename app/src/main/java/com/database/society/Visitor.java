...
public class Visitor extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            i=new Intent(Visitor.this,HomePage.class);
            startActivity(i);
            // Handle the camera action
        } else if (id == R.id.notice) {
            i=new Intent(Visitor.this,MainActivity.class);
            startActivity(i);
            ...
            i=new Intent(Visitor.this,RaiseComplain.class);
            startActivity(i);
        }else if (id == R.id.submenu2) {
            i=new Intent(Visitor.this,ViewComplain.class);
            startActivity(i);
        }

        else if (id == R.id.rule) {
            i=new Intent(Visitor.this,Rule.class);
            startActivity(i);
            ...
            i=new Intent(Visitor.this,Polling.class);
            startActivity(i);

        } else if (id == R.id.visitors){
            i=new Intent(Visitor.this,Visitor.class);
            startActivity(i);

        } else if (id == R.id.facility){
            i=new Intent(Visitor.this,Facility.class);
            startActivity(i);
