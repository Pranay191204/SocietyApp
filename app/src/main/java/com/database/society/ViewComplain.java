...
public class ViewComplain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
String username="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbl.addTab(tbl.newTab().setText("Open Complain"));
        tbl.addTab(tbl.newTab().setText("Close Complain"));
            ...
            builder.setMessage("Are you sure you want to logout?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Intent i =new Intent(ViewComplain.this,Login.class);
                            startActivity(i);
                            finish();
                        }
                    })
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            i=new Intent(ViewComplain.this,HomePage.class);
            startActivity(i);
            // Handle the camera action
        } else if (id == R.id.notice) {
            i=new Intent(ViewComplain.this,MainActivity.class);
            startActivity(i);
        } else if (id == R.id.complain) {

        }
        else if (id == R.id.submenu1) {
            Intent intent= new Intent(ViewComplain.this,RaiseComplain.class);
            intent.putExtra("username",username);
            // intent.putExtra("unit_nos",unit_no);
            startActivity(intent);
        }else if (id == R.id.submenu2) {
            i=new Intent(ViewComplain.this,ViewComplain.class);
            startActivity(i);
        }
        else if (id == R.id.rule) {
            i=new Intent(ViewComplain.this,Rule.class);
            startActivity(i);

        } else if (id == R.id.maintenance) {

        } else if (id == R.id.polling) {
            i=new Intent(ViewComplain.this,Polling.class);
            startActivity(i);

        } else if (id == R.id.visitors){
            i=new Intent(ViewComplain.this,Visitor.class);
            startActivity(i);

        } else if (id == R.id.facility){
            i=new Intent(ViewComplain.this,Facility.class);
            startActivity(i);
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
